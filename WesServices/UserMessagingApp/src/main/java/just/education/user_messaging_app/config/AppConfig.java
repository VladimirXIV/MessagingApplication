...
import just.education.user_messaging_app.service.UserService;
import just.education.user_messaging_app.service.PostService;
import just.education.user_messaging_app.service.MessageService;
import just.education.user_messaging_app.service.FriendshipService;
import just.education.user_messaging_app.service.FollowshipService;

import just.education.user_messaging_app.mapper.UserMapper;
import just.education.user_messaging_app.mapper.PostMapper;
import just.education.user_messaging_app.mapper.MessageMapper;
import just.education.user_messaging_app.mapper.FriendshipMapper;
import just.education.user_messaging_app.mapper.FollowshipMapper;

import just.education.user_messaging_app.serviceimpl.UserServiceImpl;
import just.education.user_messaging_app.serviceimpl.PostServiceImpl;
import just.education.user_messaging_app.serviceimpl.MessageServiceImpl;
import just.education.user_messaging_app.serviceimpl.FriendshipServiceImpl;
import just.education.user_messaging_app.serviceimpl.FollowshipServiceImpl;

import just.education.user_messaging_app.repository.UserRepository;
import just.education.user_messaging_app.repository.PostRepository;
import just.education.user_messaging_app.repository.MessageRepository;
import just.education.user_messaging_app.repository.FriendshipRepository;
import just.education.user_messaging_app.repository.FollowshipRepository;
