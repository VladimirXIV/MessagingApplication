package just.education.user_messaging_app.controller;
...
public class UserController {
    ...
    @GetMapping(path = "/{id}/secure_for")
    public String getSecureFor() {

        return "Hey from getSecureFor";
    }

    @GetMapping(path = "/{id}/unsecure_for")
    public String getUnsecureFor() {

        return "Hey from getUnecureFor";
    }
}