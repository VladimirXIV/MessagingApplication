...
public class CS8_AddEditorRole implements CustomTaskChange {
    ...
    public void execute(Database database) throws CustomChangeException {
        ...
        BasicDBObject permissionSearchQuery = new BasicDBObject("name", new BasicDBObject("$in", Arrays.asList("read", "write", "update")));
